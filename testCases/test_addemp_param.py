...
class Test_Login:
    ...
    @pytest.mark.test6
    def test_add_emp(self, setup, random_generator,getdataforaddemp):
        self.driver = setup
        ...
        time.sleep(4)
        self.ae.enterfirstname(getdataforaddemp[0])
        self.ae.entermiddletname(getdataforaddemp[1])
        self.ae.enterlastname(getdataforaddemp[2])
        self.ae.enterempid(getdataforaddemp[3])
        # time.sleep(2)
        ...
        self.ae.enterpassword(getdataforaddemp[5])
        self.ae.enterconfrimpassword(getdataforaddemp[5])
        self.ae.clicksave()
